"""
Django settings for quitbot project.
...
class Base(Configuration):
    ...
    SECRET_KEY = values.Value('YwUTjyJrPavmaUYTvzxYBfvibLlYXsfplqaDHeajoxlJzljdOu')
    ...
    QUITBOT_APPS = ['twitter_data']
    INSTALLED_APPS = DJANGO_APPS + THIRD_PARTY_APPS + QUITBOT_APPS
    ...
    MIDDLEWARE = [
        ...
        "quitbot.middleware.TimezoneMiddleware",
    ...
    WSGI_APPLICATION = "quitbot.wsgi.application"

    # Database
    # https://docs.djangoproject.com/en/4.1/ref/settings/#databases

    DATABASES = values.DatabaseURLValue("postgresql://quitbot_user:quitbot_pass@127.0.0.1:5432/quitbot_db")
...
class Testing(Development):
    ...
    DATABASES = values.DatabaseURLValue( # This is about defaulting to running vs docker db if you don't specify something else
        "postgresql://quitbot_user:quitbot_pass@127.0.0.1:5433/quitbot_db")
